# -*- coding: utf-8 -*-
{
    ...
    'summary': """
    Sencilla Lista de tareas diseñada por arteMAD""",

    'description': """
    Sencilla lista de tareas diseñada para mejorar dia a dia 
    la eficiencia de las tareas programadas de las personas. 
    """,
